...
Mundana_Kirki::add_field( 'mundana_theme', array(
	...
	'label'       => esc_attr__( 'Container Width - default 1070px - check without customizer sidebar', 'mundana' ),
	'section'     => 'section_theme_style',
	'priority'    => 10,
	'default'     => '1070px',
    'output' => array(
...
Mundana_Kirki::add_field( 'mundana_theme', array(
	'type'        => 'color-alpha',
	'settings'    => 'home_intro_bg',
	'label'       => esc_attr__( 'Home Sticky Post Background', 'mundana' ),
	'section'     => 'section_theme_style',
	'priority'    => 10,
	'default'     => '#e8f3ec',
    'output' => array(
        array(
			'element'  => '.introjumbo.bglight',
			'property' => 'background-color',
		),
	),
) );
...
Mundana_Kirki::add_field( 'mundana_theme', array(
	...
	'output' => array(
		array(
			'element' => array('b, strong, .font-weight-bold, h1, h2, h3, h4, h5, h6, .h1, .h2, .h3, .h4, .h5, .h6'),
		),
	),
) );
