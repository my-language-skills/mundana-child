...
<?php 
    ...
    <h4 class="font-weight-bold spanborder"><span class="border-0"><?php _e( 'Popular', 'mundana' ); ?> in <div class="text-capitalize d-inline">"<?php the_archive_title() ?>"</div> </span></h4>
    <?php } ?>
