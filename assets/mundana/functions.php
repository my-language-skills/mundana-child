...
add_image_size('postbox-sticky', 535, 364, array('center', 'top'));
...
add_image_size('single-tall-image', 500, 500, array('center', 'top'));
...
wp_enqueue_style('mundana-styles', get_stylesheet_directory_uri() . '/assets/css/theme.min.css', array(), $css_version);
...
<svg style="fill: rgba(0,0,0,0.45); margin-left: 3px; margin-top: -2px; display: inline-block;" xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php 
																																																																																																																								if (get_the_modified_time('U') > get_the_time('U')) {
																																																																																																																										echo __('Updated ', 'mundana') . get_the_modified_time('M j, Y');
																																																																																																																								} else {
...
<div class="mb-5 d-flex justify-content-between postbox" id="post-<?php echo the_ID(); ?>">
    ...
    <div class="col-md-3 pr-0 text-right"><a href="<?php echo get_permalink(); ?>">
...
<div class="introjumbo jumbotron rounded-0 mb-5 p-0 bglight position-relative post-sticky">
    <div class="row justify-content-between">
        <div class="col-md-6 pt-4rem pb-4rem pl-5 pr-5 align-self-center">
            ...
            <a href="<?php echo get_permalink(); ?>" class="btn btn-dark">
                <?php _e('Read more', 'mundana'); ?></a>
        </div>
        <div class="col-md-6 p-0 text-right bgcover d-none d-md-block" style="background-image:url(<?php echo $bgurl; ?>);">
        </div>
    </div>
</div>
<?php 
...
<div class="sticky-top sticky-sidebar-offset mundana_claps_popular">
    <h4 class="spanborder h4"><span class="border-0">
            <?php _e('Popular on', 'mundana'); ?>
            <?php echo get_bloginfo('name'); ?></span></h4>
            ...
            <span>
                ...
                <div class="text-muted">
                    ...
                    <?php if (!empty($categories)) {
																								echo '<a class="text-muted text-capitalize" href="' . esc_url(get_category_link($categories[0]->term_id)) . '">' . esc_html($categories[0]->name) . '</a>';
																						} ?>
                    <?php if ($disabledatecard == 0) { ?> ·
