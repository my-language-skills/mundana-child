...
<?php
    ...
    <div class="col-md-4 thesidebar">
      ...
      <h5>Search Revisions pages</h5>
      <?php if ( in_category( 'revisions' ) )  : echo do_shortcode ( '[searchandfilter id="2307"]' ); endif; ?> <br>
      <!-- end WorkSheet new section -->

        <!-- widgets -->
                <?php if ( is_active_sidebar( 'revisions-books4languages-widget-area' ) ) : ?>
                    <div id="sidebar-home" class="sidebar-home widget-area" role="complementary">
                        <?php dynamic_sidebar( 'revisions-books4languages-widget-area' ); ?>
                    </div>
                <?php endif; ?>
            <!-- end widgets -->
        <?php
