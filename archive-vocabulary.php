...
<div class="row justify-content-between">
  ...
  <div class="col-md-4">
    ...
    <!-- widgets -->
    <?php if ( is_active_sidebar( 'vocabulary-books4languages-widget-area' ) ) : //WorkSheet widget area ?>
    <div id="sidebar-home" class="sidebar-home widget-area" role="complementary">
      <?php dynamic_sidebar( 'vocabulary-books4languages-widget-area' ); //WorkSheet widget area ?>
    </div>
    <?php endif; ?>
