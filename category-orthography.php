...
<?php
    ...
    <div class="col-md-4 thesidebar">
      ...
      <h4><?php echo worksheet_count_cat_post('orthography'); ?> orthography topics</h4><hr><br>
      <?php endif; ?>

      <h5>Search Orthography topics</h5>
      <?php if ( in_category( 'orthography' ) )  : echo do_shortcode ( '[searchandfilter id="595"]' ); endif; ?> <br>
      <!-- end WorkSheet new section -->


        <!-- widgets -->
                <?php if ( is_active_sidebar( 'orthography-books4languages-widget-area' ) ) : ?>
                    <div id="sidebar-home" class="sidebar-home widget-area" role="complementary">
                        <?php dynamic_sidebar( 'orthography-books4languages-widget-area' ); ?>
                    </div>
                <?php endif; ?>
            <!-- end widgets -->
        <?php
